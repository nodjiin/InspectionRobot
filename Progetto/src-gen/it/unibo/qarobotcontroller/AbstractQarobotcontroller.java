	...
	protected alice.tuprolog.SolveInfo sol;
		...
		*/
	    ...
	    nPlanIter++;
	    		//senseEvent
	    		timeoutval = 200000;
	    		aar = senseEvents( timeoutval,"usercmd,sensordata","continue,continue",
	    		...
	    		if( currentEvent.getEventId().equals("sensordata") ){
	    		 		String parg = " \"SENSOREEEEEEEEEEEEEEE\" ";
	    		 		parg = updateVars(null, Term.createTerm("sensordata(X)"), Term.createTerm("sensordata(CMD)"), 
	    		...
	    		//onEvent
	    		if( currentEvent.getEventId().equals("sensordata") ){
	    		 		String parg="robotcommand(h(medium))";
	    		 		parg = updateVars(null,Term.createTerm("sensordata(X)"),  Term.createTerm("sensordata(CMD)"), 
	    		 			    		  					Term.createTerm(currentEvent.getMsg()), parg);
	    ...
	    nPlanIter++;
	    		...
	    		if( (guardVars = evalTheGuard( " !?turn(TIME)" )) != null ){
	    		temporaryStr = unifyMsgContent("robotcommandd(X,Y)","robotcommandd(a(low),TIME)", guardVars ).toString();
	    		sendMsg("robotcommandd","qarobotexecutor", ActorContext.dispatch, temporaryStr ); 
	    		}
	    		temporaryStr = unifyMsgContent("robotcommandd(X,Y)","robotcommandd(w(low),1500)", guardVars ).toString();
	    		sendMsg("robotcommandd","qarobotexecutor", ActorContext.dispatch, temporaryStr ); 
	    		...
	    		if( (guardVars = evalTheGuard( " !?turn(TIME)" )) != null ){
	    		temporaryStr = unifyMsgContent("robotcommandd(X,Y)","robotcommandd(d(low),TIME)", guardVars ).toString();
	    		sendMsg("robotcommandd","qarobotexecutor", ActorContext.dispatch, temporaryStr ); 
	    		}
	    		temporaryStr = unifyMsgContent("robotcommandd(X,Y)","robotcommandd(w(low),3000)", guardVars ).toString();
	    		sendMsg("robotcommandd","qarobotexecutor", ActorContext.dispatch, temporaryStr ); 
	    		temporaryStr = " \"Controller to robot --> please shoot a photo!\" ";
	    		println( temporaryStr );  
	    		//delay
	    		...
	    		sendMsg("robotcommand","qarobotexecutor", ActorContext.dispatch, temporaryStr ); 
	    		temporaryStr = " \"Sending the result to the ASC\" ";
	    		println( temporaryStr );  
	    		temporaryStr = unifyMsgContent("inspectionresult(X)","inspectionresult(pictures)", guardVars ).toString();
	    		sendMsg("inspectionresult","asc", ActorContext.dispatch, temporaryStr ); 
	    		temporaryStr = " \"***************** AUTONOMOUS PHASE *****************\" ";
	    		println( temporaryStr );  
