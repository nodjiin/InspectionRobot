...
prepareMoves:-findall( MOVE,moved( MOVE,DURATION),MOVES),findall( DURATION,moved( MOVE,DURATION),DURATIONS),prepareMoves( MOVES,DURATIONS).
autoReverse( A):-findall( MOVE,moved( MOVE,DURATION),MOVES),findall( DURATION,moved( MOVE,DURATION),DURATIONS),robotgui( MOVES,DURATIONS).
autoDirect( A):-findall( MOVE,moved( MOVE,DURATION),MOVES),findall( DURATION,moved( MOVE,DURATION),DURATIONS),reverse( MOVES,INV_MOVES),reverse( DURATIONS,INV_DURATIONS),robotgui( INV_MOVES,INV_DURATIONS).
/*
------------------------------------------------------------------------
